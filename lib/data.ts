...
const productsData: IProduct[] = [
  ...
  },
  {
    ...
    summary: "Dried onion flakes that provide the authentic flavor of fresh onions in a convenient, long-lasting form. Used in soups, sauces, and ready-to-eat meals.",
    specs: {
      grade: "A-Grade",
      keyParameters: {
        moisture: "5% max",
        sizeOrLength: "Standard size 8-25mm",
        defects: "Low bacterial count",
        purityOrActives: "Strong, pungent flavor",
      },
      compliance: {
        marketMRLs: ["Europe", "North America"],
        gmo: "Non-GMO",
        allergens: "None",
      },
    },
    origin: { country: "India", region: "Gujarat, Maharashtra" },
    packaging: {
      options: ["14kg paper bags with inner poly liner, packed in cartons"],
      palletization: true,
      containerLoadability: { "20ft": 7, "40ft": 15 },
    },
    trade: {
      moq: "7 MT",
      leadTime: "2-3 weeks",
      incoterms: ["FOB Mundra", "CIF"],
      paymentTerms: ["LC, TT"],
      inspection: "As per buyer's requirement",
      documents: ["Standard export documents, Certificate of Analysis"],
    },
    certifications: ["APEDA"],
    shelfLife: "24 months",
    storage: "Store in a cool, dry place, away from strong odors.",
    capabilities: { privateLabel: true, monthlyCapacityMT: 300, samples: "Available (100g)" },
    pricing: { currency: "USD", basis: ["FOB"], priceOnRequest: true, notes: "Also available in minced, chopped, and powder forms." },
    notes: "A lightweight product with high volume, ideal for cost-effective shipping.",
  },
    {
    id: "non-basmati-rice",
    ...
    summary: "Versatile and widely consumed non-aromatic rice, available in various forms such as long-grain, medium, and short-grain. A staple food for a large part of the world.",
    specs: {
      grade: "A-Grade (e.g., IR-64, Sona Masoori)",
      keyParameters: {
        moisture: "14% max",
        purityOrActives: "Purity 94% min",
        sizeOrLength: "Average Grain Length 5.8-6.5 mm",
        defects: "Broken 5% / 25% / 100% as per requirement",
        foreignMatter: "< 1%",
      },
      compliance: {
        marketMRLs: ["Africa", "Asia", "GCC"],
        gmo: "Non-GMO",
        allergens: "Gluten-free",
      },
    },
    origin: { country: "India", region: "Andhra Pradesh, West Bengal, Uttar Pradesh" },
    packaging: {
      options: ["25kg PP bags", "50kg PP/Jute bags"],
      palletization: true,
      containerLoadability: { "20ft": 26, "40ft": 28 },
    },
    trade: {
      moq: "1 x 20ft Container (approx. 26 MT)",
      leadTime: "20-25 days",
      incoterms: ["FOB Kakinada/Mundra", "CIF"],
      paymentTerms: ["LC at sight", "30% TT Advance, 70% against Scanned B/L"],
      inspection: "SGS or any third party at buyer's cost",
      documents: ["Commercial Invoice", "Packing List", "Bill of Lading", "Certificate of Origin", "Phytosanitary Certificate", "Fumigation Certificate"],
    },
    certifications: ["APEDA"],
    shelfLife: "24 months",
    storage: "Store in a cool, dry place away from direct sunlight.",
    capabilities: { privateLabel: true, monthlyCapacityMT: 20000, samples: "Available (1kg)" },
    pricing: { currency: "USD", basis: ["FOB", "CIF"], priceOnRequest: true, notes: "Price is highly dependent on the percentage of broken rice." },
    notes: "Available in Raw, Parboiled (Sella), and Steam varieties.",
  },
  {
    id: "yellow-maize",
